...
public class RobotContainer {
  ...
  public RobotContainer() {
    switch (Constants.currentMode) {
      case REAL:
        ...
        drive = new Drive(new DriveIOSim(), new GyroIONavX());
  ...
  private void configureButtonBindings() {
    ...
    controller.L2().whileTrue(superstructure.intake());
    controller.R2().whileTrue(superstructure.launch());
    controller.R1().whileTrue(superstructure.eject());
  }
