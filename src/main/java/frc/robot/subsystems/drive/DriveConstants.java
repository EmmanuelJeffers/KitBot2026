...
public class DriveConstants {
  ...
  public static final int leftLeaderCanId = 11;
  public static final int leftFollowerCanId = 12;
  public static final int rightLeaderCanId = 13;
  public static final int rightFollowerCanId = 14;
